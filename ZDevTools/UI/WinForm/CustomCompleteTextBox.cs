...
namespace ZDevTools.UI.WinForm
{
    ...
    /// 带下拉列表的自定义搜索文本框
    /// </summary>
    [Description("带下拉列表的自定义搜索文本框")]
    [ToolboxItem(true)]
    [DefaultProperty("DropDownMinCharLength"), DefaultEvent("Match")]
    [ToolboxBitmap(typeof(CustomCompleteTextBox))]
    public partial class CustomCompleteTextBox : TextBox
    {
        ...
        {
            Application.RemoveMessageFilter(this.mouseWheel);
            Application.RemoveMessageFilter(this.appClick);
